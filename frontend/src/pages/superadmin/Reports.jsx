  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 text-center">
        ...
        <h2 className="text-xl font-semibold mb-2">Monthly PDF Growth Reports</h2>
        <p className="text-gray-400 mb-1">Coming in Phase 3 — Partner tier feature</p>
        <p className="text-gray-500 text-sm max-w-md mx-auto mt-3">
          Auto-generated on the 1st of every month per clinic. Includes appointments summary,
          retention stats, review counts, and AI-generated recommendations.
          Automatically emailed to clinic owners.
        </p>
        <div className="mt-6 inline-block bg-gray-900 border border-gray-800 rounded-xl px-6 py-3 text-sm text-gray-400">
          Available for Partner plan
        </div>
      </div>
    </div>
  );
